...
public class Arrow : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        else if (pt == ProjectileType.bot)
        {
         ...
         if (pTarget == ProjectileTarget.right)
        {
            startpos= startPositions [0];
            
        }
        else if (pTarget == ProjectileTarget.center)
        {
            startpos= startPositions [1];
            
        }
        else if(pTarget == ProjectileTarget.left)
        {
            startpos= startPositions [2];
    ...
    public void setEnum(string enumSet)
    {
        ...
        else if(enumSet =="left"){
            pTarget = ProjectileTarget.left;
        }
        else if(enumSet =="center"){
            pTarget = ProjectileTarget.center;
        }
        else if(enumSet =="right"){
            pTarget = ProjectileTarget.right;
        }
        else{
    ...
    GameObject GetStartPos()
    {
        ...
        } else
        {
            ...
            if (pt == ProjectileType.top)
            {
                return startPositions[1]; // top start pos
            }
            else if (pt == ProjectileType.mid)
            {
                return startPositions[0]; // mid start pos
            }
            else if (pt == ProjectileType.bot)
            {
                return startPositions[2]; // bottom start pos
            }
            else
            {
                Debug.Log("problems with findings starting posistions!");
